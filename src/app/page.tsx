export const Home = () => {
  return (
    <div className="flex flex-1 flex-col gap-2 p-4 lg:gap-4 lg:p-4 h-full">
      ...
      <div className="grid grid-rows-[196px,auto]  grid-cols-2 gap-6 h-full">
        ...
        <div className="p-4 col-span-2 rounded-lg border border-dashed shadow-sm bg-slate-50 dark:bg-slate-900">
